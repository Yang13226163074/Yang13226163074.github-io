$(function(){
	...
	function crateMusicItem(index,music){
		var $item = $("\
			<li class=\"list_music\">\n\
					...
					<div class=\"list_time\"><span>"+music.time+"</span><a href=\"javascript:;\" class=\"list_delete\" title=\"删除\"></a></div>\n\
			</li>");
    ...
    function initEvents(){
    	...
    	// 复选框点击
    	$(".content_left_ul").delegate(".list_check","click",function(){
    	...
    	$(".content_left_ul").delegate(".list_menu_play","click",function(){
    	...
    	$musicPlay.click(function(){
    		...
    		if(player.currentTime == -1){
    			...
    			$(".list_music").eq(player.currentTime).find(".list_menu_play").trigger("click");
    		}
    	});
    	// 下一首按钮
    	$(".music_next").click(function(){
    		$(".list_music").eq(player.nextIndex(Mode)).find(".list_menu_play").trigger("click");
    	});
    	// 上一首按钮
    	...
    	// 删除键点击事件
    	$(".content_left_ul").delegate(".list_delete","click",function(){
    	...
    	$(".clearMusic").click(function(){
    		$(".list_checked").each(function(index,ele){
    			$(ele).parents(".list_music").find(".list_delete").trigger("click");
    		});
    	});
    	// 清空列表点击事件
